...
root = tk.Tk()
root.title("Rejestracja na festiwal")
# Etykiety i pola tekstowe

label_title = tk.Label(root, text="Imię:", fg="black", bg="#FFFF00")
...
label_author = tk.Label(root, text="Nazwisko:", fg="black", bg="#FFFF00")
...
label_year = tk.Label(root, text="Preferencje wolontariackie:")
...
label_year = tk.Label(root, text="Dostępność czasowa:")
...
label_year = tk.Label(root, text="Referencje:")
label_year.grid(row=16, column=0, padx=10, pady=5, sticky="w")
entry_year = tk.Entry(root, width=40)
entry_year.grid(row=16, column=1, padx=10, pady=5)
label_year = tk.Label(root, text="Dlaczego chcesz być wolontariuszem?:")
label_year.grid(row=17, column=0, padx=10, pady=5, sticky="w")
entry_year = tk.Entry(root, width=40)
entry_year.grid(row=17, column=1, padx=10, pady=5)
label_year = tk.Label(root, text="Uwagi dodatkowe:")
label_year.grid(row=18, column=0, padx=10, pady=5, sticky="w")
entry_year = tk.Entry(root, width=40)
entry_year.grid(row=18, column=1, padx=10, pady=5)
label_year = tk.Label(root, text="Skąd dowiedzialeś/aś się o wydarzeniu?:")
label_year.grid(row=19, column=0, padx=10, pady=5, sticky="w")
entry_year = tk.Entry(root, width=40)
entry_year.grid(row=19, column=1, padx=10, pady=5)
